...
export const ACES_INFO = {
  ...
  heroTagline: 'THINK. BUILD. INNOVATE.',
  registrationDeadline: '15 • 08 • 2026',
...
export const SOCIAL_LINKS = [
  {
    ...
    title: 'INSTAGRAM',
    handle: 'ACES',
    url: ACES_PLACEHOLDERS.INSTAGRAM_LINK,
    icon: 'instagram',
  ...
  },
  {
    ...
    url: ACES_PLACEHOLDERS.LINKEDIN_LINK,
    icon: 'linkedin',
  ...
  },
  {
    ...
    title: 'EMAIL',
    handle: '[ACES_EMAIL]',
    url: `mailto:${ACES_PLACEHOLDERS.EMAIL}`,
    icon: 'email',
